...
const MOCK_FREELANCERS = [
  {
    ...
    username: "@elgun09",
    avatar: "EY",
    title: "Founder Frilans.az",
    isVerified: true,
    price: "1500",
    currency: "AZN",
    priceText: "-dən başlayır",
    reviews: { pos: "+0", neg: "-0" },
    description: "Professional Web-Developer, Graphic Designer and SEO Engineer. 8 years of programming practice and 5 years of graphic design. Instagram: @elgun09",
    skills: ["Veb-Saytların hazırlanması", "Back-end", "Front-end", "iOS", "Android", "Serverlər", "Logotipin hazırlanması", "Vektor qrafika"],
    stats: {
      views: 1262,
      completedOrders: 0,
      conflictJobs: 0,
      customerReviews: { pos: "+0", neg: "-0" },
      registration: "22/05/2024",
      lastActive: "87 gün öncə"
    },
    coverImage: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&q=80&w=2072",
    portfolio: [
      { id: 1, title: "LOGO", views: 620, type: "design", bg: "bg-blue-500" },
      { id: 2, title: "SAAT SALE", views: 549, type: "design", bg: "bg-red-500" }
    ],
    experience: "5 ildən çox"
  },
  {
    id: 2,
    name: "Fidan Əsgərova",
    ...
    priceText: "-dən başlayır",
    reviews: { pos: "+0", neg: "-0" },
    description: "SMM, Mobilograph. Müxtəlif layihələr üçün sosial media mətnləri, məhsul təsvirləri və bir çox sahədə kontentlər. Sosial medyanın idarə edilməsi, video edit. İg: @fdn.grv",
    skills: ["Kopiraytinq", "Video montaj", "Audio", "Adlandırma və şüarlar", "Tərcümə"],
    stats: {
      views: 845,
      completedOrders: 12,
      conflictJobs: 0,
      customerReviews: { pos: "+15", neg: "-0" },
      registration: "10/01/2024",
      lastActive: "2 gün öncə"
    },
    coverImage: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?auto=format&fit=crop&q=80&w=2074",
    portfolio: [],
    experience: "2-5 il"
  }
];
...
const MOCK_CLIENT = {
  name: "Əhməd Hacıtalıbov",
  avatar: "ƏH",
  isPro: true,
  stats: {
    userViews: 108,
    completedOrders: 0,
    seekingFreelancers: 1,
    conflictJobs: 0,
    freelancerReviews: { pos: "+0", neg: "-0" },
    registration: "10/06/2025",
    lastActive: "317 gün öncə"
  }
};

const MOCK_CLUB_POSTS = [
  { id: 1, days: 819, comments: 20, views: 1066, title: "Frilans-da ilk post", category: "Müzakirə" },
  { id: 2, days: 513, comments: 6, views: 449, title: "Vacib məlumat!", category: "Müzakirə" },
  { id: 3, days: 796, comments: 4, views: 576, title: "Tələb olunan funksional və yaranan problemlər", category: "Müzakirə" },
];
